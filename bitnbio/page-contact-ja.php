<?php get_template_part('./layout/header'); ?>
      <div class="contact -ja lower" data-page="contact">
        <div class="inner">
          ...
          <div class="contact_inner">
            <div class="contact_lang">
              <a href="<?php echo esc_url( home_url() ); ?>/contact-ja/" class="contact_langLink -current B">JP</a>
              <a href="<?php echo esc_url( home_url() ); ?>/contact-en/" class="contact_langLink B">EN</a>
            </div>
            <?php the_content(); ?>
          </div>
        </div>
